python main.py --root_path /home/ubuntu/3D-ResNets-PyTorch/data --video_path motorbike_crossing_jpgs \
--result_path results_motorbike_crossing --n_classes 2 --n_pretrain_classes 700 \
