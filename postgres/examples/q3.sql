...
SELECT DISTINCT vid, fid1, fid2, o0_oid, o1_oid FROM g0_seq WHERE fid2 - fid1 + 1 = 2;
...
SELECT DISTINCT vid, fid1, fid2, o0_oid, o1_oid, o2_oid FROM g2_seq WHERE fid2 - fid1 + 1 = 1;
...
WHERE t0.vid = t1.vid and t0.fid < t1.fid1 and t0.o0_oid = t1.o0_oid and t0.o1_oid = t1.o1_oid and t0.o2_oid = t1.o2_oid
