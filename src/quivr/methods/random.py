...
class Random(BaseMethod):
    ...
    def __init__(self, inputs, labels, predicate_dict, max_npred, max_depth, max_duration, beam_width, k, samples_per_iter, budget, multithread):
    ...
    def run(self, init_labeled_index):
        ...
        for pred in self.predicate_dict:
            ...
            for pred_instance in pred_instances:
                ...
                print("initialization", print_program(query_graph.program))
                self.candidate_queries.append([query_graph, -1])
