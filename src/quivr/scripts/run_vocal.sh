...
# python synthesize.py --method vocal_postgres --n_init_pos 2 --n_init_neg 10 --dataset_name "synthetic_rare" --npred 5 --depth 3 --max_duration 5 --beam_width 5 --k 100 --samples_per_iter 5 --multithread 4 --strategy "topk" --query_str "Sequencing(Sequencing(Sequencing(Sequencing(Sequencing(Sequencing(True*, BackOf), True*), Duration(Conjunction(Near_1.05, LeftOf), 4)), True*), Conjunction(TopQuadrant, Near_1.05)), True*)" --run_id 0 --output_to_file

python synthesize.py --method vocal_postgres --n_init_pos 2 --n_init_neg 10 --dataset_name "without_duration-sampling_rate_4" --npred 4 --depth 3 --max_duration 1 --max_vars 2 --beam_width 5 --pool_size 100 --k 100 --budget 20 --multithread 1 --strategy "topk" --query_str "Far_3(o0, o1); Near_1(o0, o1); Far_3(o0, o1)" --run_id 0