...
python synthesize.py --method vocal --npred 5 --depth 3 --k 32 --max_duration 2 --multithread 4 --query_str "Sequencing(Sequencing(Sequencing(Sequencing(Sequencing(Sequencing(True*, Conjunction(Front, Left)), True*), Duration(Left, 2)), True*), Conjunction(Far_0.9, Left)), True*)"
