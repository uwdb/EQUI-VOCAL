...
from utils import print_program, rewrite_program, str_to_program
...
class VOCAL(BaseMethod):
    ...
    def __init__(self, inputs, labels, predicate_dict, max_npred, max_depth, max_duration, beam_width, pool_size, k, budget, multithread, strategy):
