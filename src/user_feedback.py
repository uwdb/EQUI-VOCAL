...
class UserFeedback:
    def __init__(self, n_frames, pos_frames):
        self.n_frames = n_frames
        self.pos_frames = pos_frames

    def run(self, frame_id_arr_to_annotate, positive_frames_seen, negative_frames_seen, pos_frames_per_instance, num_positive_instances_found, plot_data_y_annotated, plot_data_y_materialized, num_materialized_frames, stats_per_chunk):
