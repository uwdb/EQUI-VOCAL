#!/bin/bash
# time /home/ubuntu/complex_event_video/src/datalog/souffle/install/bin/souffle queries/q1.2_filter-seq.dl -p data/profile_log_files/q1.2_filter-seq.log -j 8
...
time /home/ubuntu/complex_event_video/src/datalog/souffle/install/bin/souffle queries/q1_bdd.dl -p data/profile_log_files/q1_bdd.log -j 4
